let StatsController =
{
	...
	countSourceContainers: function (room)
	{
	...
	summarizeRoomInternal: function (room)
	{
		if (_.isString(room))
		{
		...
		const num_source_containers = this.countSourceContainers(room);
	...
	summarizeRooms: function (room)
	{
		...
		{
			let summary = this.summarizeRoomInternal(Game.rooms[r]);
			retval[r] = summary;
		}
